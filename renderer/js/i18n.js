...
const packs = {
  ...
  en: {
    ...
    undo:'Undo',redo:'Redo',cut:'Cut',copy:'Copy',paste:'Paste',selectAll:'Select All',copyLine:'Copy Line',deleteLine:'Delete Line',
    ...
    line:'Line',column:'Column',selected:'Selected',restartTitle:'Language changed',
...
const extendedPacks = {
  ru: {
    ...
    copyLine:'Копировать строку',deleteLine:'Удалить строку',wordWrap:'Перенос строк',fontSizeUp:'Увеличить шрифт',fontSizeDown:'Уменьшить шрифт',
    ...
    previewMode:'Предпросмотр',saved:'Сохранено',generating:'Генерация',wrap:'Перенос',currentModel:'Текущая модель',line:'Строка',column:'Столбец',selected:'Выбрано',
  },
  es: {
    ...
    copyLine:'Copiar línea',deleteLine:'Eliminar línea',wordWrap:'Ajuste de línea',fontSizeUp:'Aumentar fuente',fontSizeDown:'Reducir fuente',
    ...
    generating:'Generando',wrap:'Ajuste',currentModel:'Modelo actual',line:'Línea',column:'Columna',selected:'Seleccionado',
  },
  pt: {
    ...
    copyLine:'Copiar linha',deleteLine:'Eliminar linha',wordWrap:'Quebra de linha',fontSizeUp:'Aumentar letra',fontSizeDown:'Diminuir letra',
    ...
    previewMode:'Pré-visualização',saved:'Guardado',generating:'A gerar',wrap:'Quebra',currentModel:'Modelo atual',line:'Linha',column:'Coluna',selected:'Selecionado',
  },
  de: {
    ...
    copyLine:'Zeile kopieren',deleteLine:'Zeile löschen',wordWrap:'Zeilenumbruch',fontSizeUp:'Schrift vergrößern',fontSizeDown:'Schrift verkleinern',
    ...
    previewMode:'Vorschau',saved:'Gespeichert',generating:'Wird generiert',wrap:'Umbruch',currentModel:'Aktuelles Modell',line:'Zeile',column:'Spalte',selected:'Ausgewählt',
  },
  it: {
    ...
    copyLine:'Copia riga',deleteLine:'Elimina riga',wordWrap:'A capo automatico',fontSizeUp:'Aumenta carattere',fontSizeDown:'Riduci carattere',
    ...
    previewMode:'Anteprima',saved:'Salvato',generating:'Generazione',wrap:'A capo',currentModel:'Modello attuale',line:'Riga',column:'Colonna',selected:'Selezionato',
  },
  ja: {
    ...
    copyLine:'行をコピー',deleteLine:'行を削除',wordWrap:'行を折り返す',fontSizeUp:'文字を大きく',fontSizeDown:'文字を小さく',
    ...
    generating:'生成中',wrap:'折り返し',currentModel:'現在のモデル',line:'行',column:'列',selected:'選択',
  },
  ko: {
    ...
    copyLine:'줄 복사',deleteLine:'줄 삭제',wordWrap:'자동 줄바꿈',fontSizeUp:'글자 크게',fontSizeDown:'글자 작게',
    ...
    generating:'생성 중',wrap:'줄바꿈',currentModel:'현재 모델',line:'줄',column:'열',selected:'선택',
  },
};
